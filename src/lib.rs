...
#[derive(Debug)]
pub struct NanoAssetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoAssetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoAsset processing");
    
    let mut processor = NanoAssetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoAssetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoAssetProcessor::new(false);
